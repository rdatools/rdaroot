...
$ scripts/root_map_heuristic_1.py -s NC -p temp/NC_2020_points.csv -a temp/NC_2020_adjacencies.csv -q
$ scripts/root_map_heuristic_1.py -s NC -p temp/NC_2020_points.csv -a temp/NC_2020_adjacencies.csv -q -u
...
def main() -> None:
    ...
    qualifier: str = (
        f"_{iterations}_heuristic1_{'unsimplified' if unsimplified else 'simplified'}"
        if qualify
        else ""
    )
